...
lg.Util.drawTilemap = function( map ) {
	...
	for( var y = 0; y < map.length; y++ ) {
		for( var x = 0; x < map[y].length; x++ ) {
			...
			// draw network
			context.fillStyle = '#222832';
			if( tile === 'X' ) context.fillRect( x*48, y*48, 48, 48 );
			if( tile === '0' ) context.fillRect( x*48, y*48+21+1, 48, 3 );
			if( tile === '11' ) {
				context.fillRect( x*48+21, y*48+21+1, 48-21, 3 );
			}
			if( tile === '12' ) {
				context.fillRect( x*48, y*48+21+1, 48-21, 3 );
			}
			if( tile === '1' ) context.fillRect( x*48+21+1, y*48, 3, 48 );
			if( tile === '13' ) {
				context.fillRect( x*48+21+1, y*48, 3, 48-21 );
			}
			if( tile === '14' ) {
				context.fillRect( x*48+21+1, y*48+21+1, 3, 48-21 );
			}
			if( tile === '2' ) {
				context.fillRect( x*48+21+1, y*48+21+1, 26, 3 );
				context.fillRect( x*48+21+1, y*48, 3, 25 );
			}
			if( tile === '3' ) {
				context.fillRect( x*48, y*48+21+1, 25, 3 );
				context.fillRect( x*48+21+1, y*48, 3, 25 );
			}
			if( tile === '4' ) {
				context.fillRect( x*48+21+1, y*48+21+1, 26, 3 );
				context.fillRect( x*48+21+1, y*48+21+1, 3, 26 );
			}
			if( tile === '5' ) {
				context.fillRect( x*48, y*48+21+1, 25, 3 );
				context.fillRect( x*48+21+1, y*48+21+1, 3, 26 );
			...
			if( tile === '6' ) {
				context.fillRect( x*48, y*48+21+1, 48, 3 );
				context.fillRect( x*48+21+1, y*48, 3, 25 );
			}
			if( tile === '7' ) {
				context.fillRect( x*48, y*48+21+1, 48, 3 );
			...
			if( tile === '8' ) {
				context.fillRect( x*48+21+1, y*48+21+1, 26, 3 );
				context.fillRect( x*48+21+1, y*48, 3, 48 );
			}
			if( tile === '9' ) {
				context.fillRect( x*48, y*48+21+1, 25, 3 );
				context.fillRect( x*48+21+1, y*48, 3, 48 );
