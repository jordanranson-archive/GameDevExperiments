...
MyGame = ig.Game.extend({
	...
	init: function() {
        ...
        this.tooltip = this.spawnEntity( 'EntityTooltip', 0, 0 );
...
ig.main( '#canvas', MyGame, 60, window.innerWidth/__gameScale, window.innerHeight/__gameScale, 4 );
