...
MyGame = ig.Game.extend({
    ...
    loadLevel: function( image ) {
        ...
        this.sortEntities();
        console.log( this.networkChunks[1][1].toDataURL() )
...
ig.Input.inject({
    initMouse: function() {
        ...
        document.addEventListener('mousedown', this.keydown.bind(this), false );
        document.addEventListener('mouseup', this.keyup.bind(this), false );
        ...
        if( ig.ua.touchDevice ) {
            ...
            // MS
            document.addEventListener('MSPointerDown', this.keydown.bind(this), false );
            document.addEventListener('MSPointerUp', this.keyup.bind(this), false );
            document.addEventListener('MSPointerMove', this.mousemove.bind(this), false );
