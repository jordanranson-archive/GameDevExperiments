...
EntityCamera = Entity3d.extend({
    ...
    init3d: function() {
        ...
        this.posz = 256+48+128;
        this.pos.y += 128;
        this.mesh2.position.z = 256+1;
    ...
    update: function() {
        ...
        if( ig.input.state( 'action2' ) ) {
            ...
            this.pos.x = (this.dragStart.x - x);
            this.pos.y = (this.dragStart.y - y);
        }

        if( ig.game._3d ) {
            if( ig.input.state( 'scroll_up' ) ) {
                if( this.posz > 256+48 ) {
                    this.pos.y -= this.posz*0.035;
                    this.posz -= this.posz*0.035;
                }
            }
